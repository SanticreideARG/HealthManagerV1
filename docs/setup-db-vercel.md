...
4. Configurá:
   - **Database name**: `health-manager` (o el que prefieras).
...
En la raíz del repo (`D:\HealthManager` o donde lo hayas clonado):
...
```env
DATABASE_URL="postgres://...-pooler.../health-manager?sslmode=require"
DATABASE_URL_UNPOOLED="postgres://.../health-manager?sslmode=require"
```
